...
public class ChargerBlock extends ARBlock{
	...
	public VoxelShape getShape(BlockState state, BlockGetter worldIn, BlockPos pos, CollisionContext context) {
		...
		VoxelShape shape8 = Shapes.box(0.125, 0.6875, 0.875, 0.1875, 0.8125, 0.8125);
		VoxelShape shape9 = Shapes.box(0.1875, 0.6875, 0.875, 0.25, 0.75, 0.8125);
		VoxelShape shape10 = Shapes.box(0.125, 0.6875, 0.8125, 0.1875, 0.75, 0.75);
		...
		VoxelShape shape14 = Shapes.box(0.875, 0.6875, 0.125, 0.8125, 0.8125, 0.1875);
		VoxelShape shape15 = Shapes.box(0.8125, 0.6875, 0.125, 0.75, 0.75, 0.1875);
		VoxelShape shape16 = Shapes.box(0.875, 0.6875, 0.1875, 0.8125, 0.75, 0.25);
