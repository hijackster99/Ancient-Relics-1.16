...
public class RelicBlock extends ShardBlock{
	...
	public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
		...
		VoxelShape shape4 = VoxelShapes.create(0.3125, 0, 0.375, 0.6875, 0.0625, 0.625);
		VoxelShape shape5 = VoxelShapes.create(0.375, 0, 0.3125, 0.625, 0.0625, 0.6875);
		VoxelShape shape6 = VoxelShapes.create(0.25, 0, 0.4375, 0.75, 0.0625, 0.5625);
		VoxelShape shape7 = VoxelShapes.create(0.4375, 0, 0.25, 0.5625, 0.0625, 0.75);
